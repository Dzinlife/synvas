import type { TimelineMeta } from "../timeline-system/types";
import { framesToSeconds } from "../timeline-system/timecode";
import type { ActiveTransitionFrameState } from "../timeline-system/transitionFrameState";
