...
function TooltipContent({
	...
	return (
		<TooltipPrimitive.Portal>
			<TooltipPrimitive.Positioner sideOffset={sideOffset} className="z-9999">
				<TooltipPrimitive.Popup
					className={cn(
						"flex items-center rounded-md bg-[canvas] px-2 py-1 text-sm text-gray-900 shadow-lg shadow-gray-200 outline-1 outline-gray-200 origin-(--transform-origin) transition-[transform,scale,opacity] data-ending-style:scale-90 data-ending-style:opacity-0 data-instant:transition-none data-starting-style:scale-90 data-starting-style:opacity-0 dark:shadow-none dark:-outline-offset-1 dark:outline-gray-300",
						className,
					)}
					{...props}
				>
