import { getCommandDescriptor } from "./registry";
import type {
	ConfirmedPlan,
	ParsedCommand,
	PlanContext,
...
export const getPlanDraft = (planId: string): PlanDraft | undefined => {
...
export const upsertPlanDraft = (plan: PlanDraft): PlanDraft => {
	planDraftStore.set(plan.id, plan);
	return plan;
};

export const discardPlanDraft = (planId: string): void => {
